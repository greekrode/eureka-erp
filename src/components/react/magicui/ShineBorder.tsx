 ...
 */
export default function ShineBorderComponent({ borderRadius = 8, borderWidth = 1, duration = 14, color = '#fff', className, children }: ShineBorderProps) {
	return (
		<div
			style={
				{
			...
			className={cn('relative grid min-h-[60px] w-fit min-w-[300px] place-items-center rounded-[--border-radius] bg-white p-3 text-black', className)}
		>
			<div
				style={
					{
