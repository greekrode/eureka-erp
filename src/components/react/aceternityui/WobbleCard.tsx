...
export const WobbleCardComponent = ({ children, containerClassName, className }: { children: React.ReactNode; containerClassName?: string; className?: string }) => {
	...
	return (
		...
		>
			<div
				className={cn('relative h-full overflow-hidden [background-image:radial-gradient(88%_100%_at_top,rgba(255,255,255,0.5),rgba(255,255,255,0))] sm:mx-0 sm:rounded-2xl', className)}
				style={{
